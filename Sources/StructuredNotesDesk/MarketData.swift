...
public enum Market {
    ...
    public static let catalog: [Asset] = [
        ...
        Asset(ticker: "XLU", name: "Utilities SPDR", cls: .indexETF, spot: 0, vol: 0.18, div: 0.028, sourced: false, tapeCount: 654, source: "assumption tier — wire a feed"),
        ...
        Asset(ticker: "SMH", name: "Semiconductor ETF", cls: .indexETF, spot: 0, vol: 0.32, div: 0.005, sourced: false, tapeCount: 633, source: "assumption tier — wire a feed"),
